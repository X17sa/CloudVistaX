...
namespace p2pconn
{
    public partial class Form1 : Form
    {
        ...
        public string peername = "Computer";
        ...
        private void GetEndPoint()
        {
            ...
            if (p2pEndPoint == null)
                return;
            MessageBox.Show("By opting to utilize CloudVista, you acknowledge and consent to abide by the established rules and guidelines.");
            MessageBox.Show("Please be aware that our staff reserves the right to monitor user input, and if alerted, may take action, including the possibility of blocking access.");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (txtnsg.Text != "")
            {
                ...
                {
                    MessageBox.Show("You are not connected to Computer endpoint");
                }
            }
            else
            {
        ...
        private void btn_paste_Click(object sender, EventArgs e)
        {
            ...
            {
                txtRemoteIP.Text = "";
                MessageBox.Show("Please paste Computer remote host:port not your!");
            }
        }
